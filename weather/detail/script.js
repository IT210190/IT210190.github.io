    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById('erg').innerHTML = '<h2 class="date" onclick="changeSite()">' + date.toString().split(" ")[0] + ' ' + (erg.list[startingNumber].dt_txt).split(" ")[0] + '</h2>' +
                ...
                '<div class="littleContainer"><h3>' + erg.list[startingNumber].weather[0].main + '</h3><img src="http://openweathermap.org/img/wn/' + erg.list[startingNumber].weather[0].icon + '@2x.png" style="margin-top: -1vh;" alt="weatherIcon"><p>' + erg.list[startingNumber].weather[0].description + '</p></div>' +
